    ...
    <>
      <div className="p-2 h-full overflow-auto">
        <div className="flex gap-4 h-full rounded-xl text-gray-800 dark:text-gray-300">
          <div className="flex flex-col w-full p-2 justify-between items-center  gap-2 text-lg bg-indigo-200  dark:bg-gray-800 dark:to-gray-950  border  border-gray-300 dark:border-gray-800 rounded-xl ">
